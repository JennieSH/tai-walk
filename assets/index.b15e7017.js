...
`,Oe=()=>{const{loadingState:e}=h.exports.useContext(W);return h.exports.useEffect(()=>{const a=document.querySelector("#root");e?(a.style.height="100vh",a.style.overflow="hidden"):(a.style.height="auto",a.style.overflow="auto")},[e]),t(Le,{children:e&&n("div",{className:"loading-container",children:[t("div",{className:"loading",children:t("div",{className:"loading-inner"})}),t("span",{children:"Loading..."})]})})};function Me(){return t(Z1,{children:n(p0,{children:[t(X1,{}),t(Oe,{}),n(R1,{children:[t(V,{exact:!0,path:"/",component:v0}),t(V,{exact:!0,path:"/:category",render:e=>d1.includes(e.match.params.category)?t(Fe,{}):t($1,{})}),t(V,{path:"/:category/:id",render:e=>d1.includes(e.match.params.category)?t(Pe,{}):t($1,{})})]}),t(He,{})]})})}const S1={color:{primary:"#7F977B",secondary:"#6E7D60",border:"#E5E5E5",active:"#65895F",focus:"#E0DA48",white:"#ffffff",red:"#FF725E",transparent:"transparent","green-50":"#E0DA48","green-100":"#CCD5CA","green-200":"#65895F","green-300":"#BEA363","gary-50":"#F9F9F9","gary-100":"#9E9E9E","gary-200":"#737373","gary-300":"#646464","gary-400":"#1E1E1E","gary-500":"#2F2F2F"},fontSize:{xs:"0.75rem",sm:"0.875rem",base:"1rem",lg:"1.125rem",xl:"1.375rem","2xl":"1.5rem","3xl":"1.75rem","4xl":"2rem","5xl":"2.25rem","6xl":"2.5rem","7xl":"3rem"},screens:{sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px"},borderRadius:{xs:"0.125rem",sm:"0.25rem",default:"0.3125rem",md:"0.375rem",lg:"0.5rem",xl:"0.75rem","2xl":"1rem","3xl":"1.5rem",full:"9999px"},fontWeight:{thin:"100",extralight:"200",light:"300",normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},fontFamily:{"noto-sans":"Noto Sans TC"}};const Ve=e=>H1`
    ${L1}
    html,
    body {
      padding: 0;
