...
`,h0=15,H=({card:e,className:a,category:o})=>t(d0,{className:a,children:n(y,{to:`/${o}/${e.ID}`,title:e.Name,children:[t("div",{className:"card-img",children:t("img",{src:e.Picture.PictureUrl1,alt:e.Picture.PictureDescription1,title:e.Picture.PictureDescription1})}),t("h3",{className:"card-title",children:x1(h0,e.Name)}),n("div",{className:"card-spot",children:[t(m,{name:"spot-line",width:"16px"}),t("span",{children:e.City})]})]})});var C;(function(e){e.ON="on",e.OFF="off"})(C||(C={}));const y1=!1,W=h.exports.createContext({loadingState:y1,loadingDispatch:()=>null}),g0=(e,a)=>{switch(a.type){case C.OFF:return!1;case C.ON:return!0;default:return e}},p0=({children:e})=>{const[a,o]=h.exports.useReducer(g0,y1);return t(W.Provider,{value:{loadingState:a,loadingDispatch:o},children:e})},m0=()=>{const e="467cc10018d4421d9c9766ad466290d8",a="qzZQjBDhgfbt7QtJPAekBBFHTik",o=new Date().toUTCString(),r=new N1("SHA-1","TEXT");r.setHMACKey(a,"TEXT"),r.update(`x-date: ${o}`);const i=r.getHMAC("B64");return{"Content-Type":"application/json",Authorization:`hmac username="${e}", algorithm="hmac-sha1", headers="x-date", signature="${i}"`,"X-Date":o}};var G;(function(e){e.PTX_URL="https://ptx.transportdata.tw/MOTC/v2/Tourism",e.GOOGLE_MAP_URL="https://www.google.com/maps/embed/v1/place"})(G||(G={}));var v1=G;const f0=j1.create({baseURL:v1.PTX_URL,headers:m0(),validateStatus:e=>e>=200&&e<400}),D=async(e,a)=>{const o=new URLSearchParams(E({$format:"JSON"},a)).toString();return await f0(`${e}?${o}`).then(i=>i.data).catch(i=>{console.error(i),alert(i)})};var b;(function(e){e.SCENIC_SPOT="/ScenicSpot",e.RESTAURANT="/Restaurant",e.ACTIVITY="/Activity"})(b||(b={}));const A={getScenicSpot(e){return D(b.SCENIC_SPOT,e)},getScenicSpotByCity(e){const i=e,{city:a}=i,o=z(i,["city"]),r=`${b.SCENIC_SPOT}/${a}`;return D(r,o)},getRestaurant(e){return D(b.RESTAURANT,e)},getRestaurantByCity(e){const i=e,{city:a}=i,o=z(i,["city"]),r=`${b.RESTAURANT}/${a}`;return D(r,o)},getActivity(e){return D(b.ACTIVITY,e)},getActivityByCity(e){const i=e,{city:a}=i,o=z(i,["city"]),r=`${b.ACTIVITY}/${e.city}`;return D(r,o)}};var v;(function(e){e.BASE="Base",e.MULTIPLE="Multiple",e.DETAIL="Detail"})(v||(v={}));const K=4,q=1,Q=99,w="Picture/PictureUrl1 ne null and City ne null",L="UpdateTime desc",O="ID,Name,Address,Picture,City",x0={[v.BASE]:{[c.ACTIVITY]:{$top:K.toString(),$select:"ID,Name,City,Picture",$filter:w,$orderBy:"StartTime desc"},[c.SCENIC_SPOT]:{$top:K.toString(),$select:O,$filter:w,$orderBy:`${L},OpenTime asc`},[c.RESTAURANT]:{$top:K.toString(),$select:O,$filter:w,$orderBy:`${L},OpenTime desc`}},[v.MULTIPLE]:{[c.ACTIVITY]:{$top:Q.toString(),$select:"ID,Name,City,Picture",$filter:w,$orderBy:L},[c.SCENIC_SPOT]:{$top:Q.toString(),$select:O,$filter:w,$orderBy:`${L},OpenTime asc`},[c.RESTAURANT]:{$top:Q.toString(),$select:O,$filter:w,$orderBy:"OpenTime asc"}},[v.DETAIL]:{[c.ACTIVITY]:{$top:q.toString(),$filter:w},[c.SCENIC_SPOT]:{$top:q.toString(),$filter:w},[c.RESTAURANT]:{$top:q.toString(),$filter:w}}},y0=(e,a)=>{switch(e){case c.SCENIC_SPOT:return a?A.getScenicSpotByCity:A.getScenicSpot;case c.RESTAURANT:return a?A.getRestaurantByCity:A.getRestaurant;case c.ACTIVITY:return a?A.getActivityByCity:A.getActivity;default:throw Error("The category is invalid! Please check again.")}},v0=e=>{const{page:a,category:o,city:r,keyword:i,date:l,id:s,position:u}=e;let p=x0[a][o];const d=[w];return r&&(p=B(E({},p),{city:r})),i&&d.push(`(contains(Description, '${i}') or contains(Name,'${i}'))`),l&&o===c.ACTIVITY&&d.push(`(date(StartTime) le ${l} and date(EndTime) ge ${l})`),u&&(p=B(E({},p),{$spatialFilter:`nearby(${u})`})),s&&d.push(`ID eq '${s}'`),p=B(E({},p),{$filter:d.join(" and ")}),p},X=()=>{const{loadingDispatch:e}=h.exports.useContext(W);return{fetchTourismData:async o=>{const r=y0(o.category,o.city),i=v0(o);e({type:C.ON});const l=await r(i);return e({type:C.OFF}),l}}},w0=()=>{const[e,a]=h.exports.useState([]),[o,r]=h.exports.useState([]),[i,l]=h.exports.useState([]),{fetchTourismData:s}=X();return h.exports.useEffect(()=>{const u=async()=>{const f=await s({page:v.BASE,category:c.ACTIVITY});a(f)},p=async()=>{const f=await s({page:v.BASE,category:c.SCENIC_SPOT});r(f)},d=async()=>{const f=await s({page:v.BASE,category:c.RESTAURANT});l(f)};u(),p(),d()},[]),n(J1,{className:"container",children:[t(i0,{}),t(s0,{}),n(e0,{children:[n("div",{className:"sub-title",children:[t("h2",{children:"\u8FD1\u671F\u6D3B\u52D5"}),n(y,{to:"/activity",className:"checkout",children:[t("span",{children:"\u67E5\u770B\u66F4\u591A\u6D3B\u52D5"}),t(m,{name:"arrow-right-r",width:"16px"})]})]}),t("div",{className:"card-list",children:e.length&&e.map(u=>t(u0,{activityCard:u,category:c.ACTIVITY},`ac-${u.ID}`))})]}),n(h1,{children:[n("div",{className:"sub-title",children:[t("h2",{children:"\u71B1\u9580\u6253\u5361\u666F\u9EDE"}),n(y,{to:"/scenic-spot",className:"checkout",children:[t("span",{children:"\u67E5\u770B\u66F4\u591A\u666F\u9EDE"}),t(m,{name:"arrow-right-r",width:"16px"})]})]}),t("div",{className:"spot-list",children:o.length&&o.map(u=>t(H,{card:u,category:c.SCENIC_SPOT},`spot-${u.ID}`))})]}),n(h1,{children:[n("div",{className:"sub-title",children:[t("h2",{children:"\u4E00\u518D\u56DE\u8A2A\u7F8E\u98DF"}),n(y,{to:"/restaurant",className:"checkout",children:[t("span",{children:"\u67E5\u770B\u66F4\u591A\u7F8E\u98DF"}),t(m,{name:"arrow-right-r",width:"16px"})]})]}),t("div",{className:"spot-list",children:i.length&&i.map(u=>t(H,{card:u,category:c.RESTAURANT},`restaurant-${u.ID}`))})]})]})},b0=g.main`
...
`;var _0="/assets/agriculture.f9a84bc2.jpg",B0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:_0}),k0="/assets/ecology.eca82464.jpg",T0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:k0}),N0="/assets/historic-site.65272568.jpg",j0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:N0}),I0="/assets/hot-spring.bc5fc94c.jpg",z0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:I0}),P0="/assets/natural.96486c19.jpg",Z0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:P0}),R0="/assets/recreation-area.e25b8e59.jpg",H0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:R0}),L0="/assets/tourist-factory.63c68b32.jpg",O0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:L0}),M0="/assets/chinese-food.2d021e12.jpg",V0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:M0}),U0="/assets/dessert.3ef3dff8.jpg",Y0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:U0}),W0="/assets/exotic-food.4660e433.jpg",G0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:W0}),K0="/assets/local-specialty.729dfaf9.jpg",q0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:K0}),Q0="/assets/souvenir.cc86f50d.jpg",X0=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:Q0}),J0="/assets/vegetarian.13a3520e.jpg",ee=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:J0}),te="/assets/annual.46eb8e3c.jpg",ae=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:te}),re="/assets/bicycle.c21ad4aa.jpg",oe=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:re}),ie="/assets/cultural.6bb0758a.jpg",ne=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:ie}),se="/assets/festival.4b21ebd7.jpg",le=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:se}),ce="/assets/recreational-activities.12bd0445.jpg",ue=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:ce}),de="/assets/seasonal.2009b9dd.jpg",he=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:de});const ge=()=>({activity:{"/src/assets/imgs/activity/annual.jpg":ae,"/src/assets/imgs/activity/bicycle.jpg":oe,"/src/assets/imgs/activity/cultural.jpg":ne,"/src/assets/imgs/activity/festival.jpg":le,"/src/assets/imgs/activity/recreational-activities.jpg":ue,"/src/assets/imgs/activity/seasonal.jpg":he},restaurant:{"/src/assets/imgs/restaurant/chinese-food.jpg":V0,"/src/assets/imgs/restaurant/dessert.jpg":Y0,"/src/assets/imgs/restaurant/exotic-food.jpg":G0,"/src/assets/imgs/restaurant/local-specialty.jpg":q0,"/src/assets/imgs/restaurant/souvenir.jpg":X0,"/src/assets/imgs/restaurant/vegetarian.jpg":ee},"scenic-spot":{"/src/assets/imgs/scenic-spot/agriculture.jpg":B0,"/src/assets/imgs/scenic-spot/ecology.jpg":T0,"/src/assets/imgs/scenic-spot/historic-site.jpg":j0,"/src/assets/imgs/scenic-spot/hot-spring.jpg":z0,"/src/assets/imgs/scenic-spot/natural.jpg":Z0,"/src/assets/imgs/scenic-spot/recreation-area.jpg":H0,"/src/assets/imgs/scenic-spot/tourist-factory.jpg":O0}}),pe=({category:e})=>{const a=ge(),{categoryState:o,categoryDispatch:r}=h.exports.useContext(b1),{title:i,list:l,categoryType:s}=o;return h.exports.useEffect(()=>{r({type:e})},[e]),n(A0,{children:[t("h2",{children:i}),t("div",{className:"category-list",children:l.map(u=>t(y,{to:`/${e}?keyword=${u.keyword}`,className:"category-item",style:{backgroundImage:`url(${a[s][u.path].default})`},children:t("h3",{children:u.text})},`category-${u.text}`))})]})},me=g.section`
...
`,ye=({className:e,date:a,changeHandler:o})=>{const[r,i]=h.exports.useState(!1),l=s=>{o(s),i(!r)};return n(xe,{className:e,children:[n("button",{className:"calendar-input",onClick:()=>i(!r),children:[a?F(a):"\u9078\u64C7\u65E5\u671F",t(m,{name:"calendar",width:"20px",height:"20px"})]}),r&&t(I1,{locale:"en",className:"calendar",onChange:l,value:a})]})},ve=g.div`
  display: flex;
  flex-wrap: wrap;
  position: relative;
  padding: 0 16px;
...
`,Oe=()=>{const{loadingState:e}=h.exports.useContext(W);return h.exports.useEffect(()=>{const a=document.querySelector("#root");e?(a.style.height="100vh",a.style.overflow="hidden"):(a.style.height="auto",a.style.overflow="auto")},[e]),t(Le,{children:e&&n("div",{className:"loading-container",children:[t("div",{className:"loading",children:t("div",{className:"loading-inner"})}),t("span",{children:"Loading..."})]})})};function Me(){return t(Z1,{children:n(p0,{children:[t(X1,{}),t(Oe,{}),n(R1,{children:[t(V,{exact:!0,path:"/",component:w0}),t(V,{exact:!0,path:"/:category",render:e=>d1.includes(e.match.params.category)?t(Fe,{}):t($1,{})}),t(V,{path:"/:category/:id",render:e=>d1.includes(e.match.params.category)?t(Pe,{}):t($1,{})})]}),t(He,{})]})})}const S1={color:{primary:"#7F977B",secondary:"#6E7D60",border:"#E5E5E5",active:"#65895F",focus:"#E0DA48",white:"#ffffff",red:"#FF725E",transparent:"transparent","green-50":"#E0DA48","green-100":"#CCD5CA","green-200":"#65895F","green-300":"#BEA363","gary-50":"#F9F9F9","gary-100":"#9E9E9E","gary-200":"#737373","gary-300":"#646464","gary-400":"#1E1E1E","gary-500":"#2F2F2F"},fontSize:{xs:"0.75rem",sm:"0.875rem",base:"1rem",lg:"1.125rem",xl:"1.375rem","2xl":"1.5rem","3xl":"1.75rem","4xl":"2rem","5xl":"2.25rem","6xl":"2.5rem","7xl":"3rem"},screens:{sm:"640px",md:"768px",lg:"1024px",xl:"1280px","2xl":"1536px"},borderRadius:{xs:"0.125rem",sm:"0.25rem",default:"0.3125rem",md:"0.375rem",lg:"0.5rem",xl:"0.75rem","2xl":"1rem","3xl":"1.5rem",full:"9999px"},fontWeight:{thin:"100",extralight:"200",light:"300",normal:"400",medium:"500",semibold:"600",bold:"700",extrabold:"800",black:"900"},fontFamily:{"noto-sans":"Noto Sans TC"}};const Ve=e=>H1`
    ${L1}
    html,
    body {
      padding: 0;
